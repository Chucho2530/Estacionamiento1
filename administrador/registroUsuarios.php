...
if($conn->connect_error){
    ...
    if($query){
        if($query->num_rows > 0){
            echo "<script>
            location.href = 'usuarios.php?errorcode=id';</script>";
        }else{
            $sql_sentence = "INSERT INTO usuarios (usuario, tipo, clavedeacceso, nombre, apellidos, telefono, correo) VALUES ('".$id."', '".$tipo."', '".$clave."', '".$nombre."', '".$apellidos."', '".$telefono."', '".$correo."')";
