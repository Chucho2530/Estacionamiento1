                ...
                <form class="col-12" method="post" action="reservarCajon.php">
                    ...
                    <div class="row col-12 d-flex flex-row justify-content-between mt-5">
                        ...
                        <div class="input-group">    
                            ...
                            <input id="input__idBuscarConductor" type="text" name="cliente" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                    </div>
                    ...
                    <div class="row col-12 d-flex flex-row justify-content-between mt-3">
                        ...
                        <div class="input-group">    
                            ...
                            <input id="input__idBuscarVehiculo" type="text" name="vehiculo" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" disabled>
                        </div>
                    </div>
...
var arregloUsuariosPHP = [<?php echo implode(",",$users);?>];
        ...
        for(i=0; i<arregloAutosPHP.length; i+=3){
